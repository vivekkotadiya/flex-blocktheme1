				...
				>
					<CardBody className="wp-block-smt-theme-content-slider__controls-wrapper">
						<div className="wp-block-smt-theme-content-slider__controls-actions">
							<Button
								label={__('Add Dozentin Slide', 'smt-theme')}
								variant="secondary"
							...
							>
								{__('Add Dozentin Slide', 'smt-theme')}
							</Button>
						</div>
					</CardBody>
				</Card>
		...
		return (
			...
			>
				<CardBody className="wp-block-smt-theme-content-slider__controls-wrapper">
					<div className="wp-block-smt-theme-content-slider__controls-actions">
						<Button
							label={__('Edit Dozentin Slide', 'smt-theme')}
							variant="secondary"
							icon="edit"
							disabled={!isEditActive}
							onClick={() => {
						...
						>
							{__('Edit Dozentin Slide', 'smt-theme')}
						</Button>
					</div>
