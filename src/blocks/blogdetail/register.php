...
register_block_type(
    GbBlocks_URL . 'build/blocks/blogdetail',
    [
        'render_callback' => 'render_blogdetail',
    ]
);
function render_blogdetail($attrs)
{
    ...
    if($post){
        ...
        if($post_id){ 
           ...
           $terms = get_the_terms($post,'category');
            ...
            <section class="section section--logo blog--hero-main">
