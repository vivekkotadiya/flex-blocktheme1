...
class Edit extends Component {
  ...
  render() {
    ...
    return (
      <>
        <InspectorControls>
          <PanelBody title={__("Logo", "smt-theme")} initialOpen={false}>
            <ToggleControl
          ...
          <PanelBody
            title={__("Sub Headline", "smt-theme")}
            initialOpen={false}>
            <ToggleGroupControl
              label={__("Tag", "smt-theme")}
          ...
          <PanelBody
            title={__("Content Settings", "smt-theme")}
            initialOpen={false}>
            <ToggleControl
              label={__("Show/Hide Link List", "smt-theme")}
              checked={showListLink}
              onChange={() =>
                setAttributes({
            ...
            />
            <ToggleControl
              label={__("Show/Hide Box 1", "smt-theme")}
              checked={showBox1}
              onChange={() =>
                setAttributes({
                  showBox1: !showBox1,
            ...
            />
            <ToggleControl
              label={__("Show/Hide Box 2", "smt-theme")}
              checked={showBox2}
              onChange={() =>
                setAttributes({
                  showBox2: !showBox2,
...
export default compose(
  withSelect((select, props) => {
    ...
    let block_template = [];
    if (showListLink == true) {
      block_template.push([
        "smt-theme/listlink",
        {
          listLinkStyle: "two",
          listLinkColor: "#ffffff",
          listLinkColorClass: "one",
        },
        [
          ["smt-theme/linkitem"],
          ["smt-theme/linkitem"],
    ...
    block_template.filter(function (value, index, arr) {
      if (showListLink == false) {
        if (value[0] != "smt-theme/listlink") {
          return arr;
        }
      } else if (showBox1 == false || showBox2 == false) {
        if (value[0] != "smt-theme/box") {
          return arr;
        }
      }
    });
    ...
    const innerBlocksProps = useInnerBlocksProps(
      { className: "row row--xs-left row--gap-1" },
      {
        allowedBlocks: ["smt-theme/listlink", "smt-theme/box"],
