...
// Event Post
register_post_meta('events', 'seo_meta_title', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'string',
]);

register_post_meta('events', 'seo_meta_description', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'string',
]);

register_post_meta('events', 'seo_no_index', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'boolean',
]);

register_post_meta('events', 'seo_no_follow', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'boolean',
]);
...
// Reports Post
register_post_meta('reports', 'seo_meta_title', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'string',
]);

register_post_meta('reports', 'seo_meta_description', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'string',
]);

register_post_meta('reports', 'seo_no_index', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'boolean',
]);

register_post_meta('reports', 'seo_no_follow', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'boolean',
]);
...
// Jobs Post
register_post_meta('jobs', 'seo_meta_title', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'string',
]);

register_post_meta('jobs', 'seo_meta_description', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'string',
]);

register_post_meta('jobs', 'seo_no_index', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'boolean',
]);

register_post_meta('jobs', 'seo_no_follow', [
	'show_in_rest' => true,
	'single' => true,
	'type' => 'boolean',
]);
...
add_action('wp_head', 'smt_seo_tag_in_frontend');

if (!function_exists('smt_seo_tag_in_frontend')) {
	function smt_seo_tag_in_frontend()
	{
