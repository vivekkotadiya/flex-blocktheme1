...
/***/ "./src/blocks/contactperson/Contactcard.js":
/*!*************************************************!*\
  !*** ./src/blocks/contactperson/Contactcard.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Contactcard = props => {
  ...
  const image = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(() => (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)("core").getMedia(featuredMediaId));
  const term = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(() => (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)("core").getEntityRecord("taxonomy", "department", departmentId));
  const termName = term?.name;
  const Imagehtml = () => {
    if (image === undefined) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null);
    }
    const xlimg = image?.media_details?.sizes?.xl ? image?.media_details?.sizes?.xl.source_url : image?.media_details?.sizes?.full.source_url;
    const xsimg = image?.media_details?.sizes?.xs ? image?.media_details?.sizes?.xs.source_url : null;
    const xsimgwebp = image?.media_details?.sizes?.xs_webp ? image?.media_details?.sizes?.xs_webp.source_url : null;
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, xlimg && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("picture", null, xsimgwebp && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("source", {
      srcset: xsimgwebp,
      type: "image/webp"
    }), xsimg && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("source", {
      srcset: xsimg
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `contact-person contact-person-${style}`
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "contact-person__image"
  }, image && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Imagehtml, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "contact-person__details"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", {
    className: "contact-person__name headline headline--align-xs-left headline--style-four headline--color-three"
  }, personName), termName && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "contact-person__department"
  }, termName), email && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "contact-person__email text text--style-one text--align-xs-left text--color-seven",
    href: `mailto:${email}`
  }, email), phone && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
...
/***/ "./src/blocks/contactperson/edit.js":
/*!******************************************!*\
  !*** ./src/blocks/contactperson/edit.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/contactperson/block.json");
/* harmony import */ var _Contactcard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Contactcard */ "./src/blocks/contactperson/Contactcard.js");
...
function edit(_ref) {
  ...
  const teamPosts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
  ...
  const Contactperson = () => {
    if (teamPosts != null && personId != 0) {
      const personPost = teamPosts.filter(teampost => teampost.id == personId);
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Contactcard__WEBPACK_IMPORTED_MODULE_6__["default"], {
        personPost: personPost,
        personId: personId,
        style: style
      });
    }
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, "Select Contact Person..");
  };
  ...
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Contactperson, null));
}
...
/***/ "./src/blocks/contactperson/block.json":
/*!*********************************************!*\
  !*** ./src/blocks/contactperson/block.json ***!
  \*********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"smt-theme/contactperson","version":"0.1.5","title":"Contact Person Preview","category":"block-category-preview","keywords":["team","person","contact"],"description":"","supports":{"html":false,"anchor":false,"customClassName":false},"attributes":{"style":{"type":"string","default":"one"},"personId":{"type":"string","default":0},"anchor":{"type":"string","default":""}},"parent":["smt-theme/column"],"textdomain":"smt-theme","editorScript":"file:./index.js"}');
...
"use strict";
/*!*******************************************!*\
  !*** ./src/blocks/contactperson/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/contactperson/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/contactperson/block.json");
