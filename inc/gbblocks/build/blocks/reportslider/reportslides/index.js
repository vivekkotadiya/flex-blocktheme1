...
/***/ "./src/blocks/reportslider/reportslides/edit.js":
/*!******************************************************!*\
  !*** ./src/blocks/reportslider/reportslides/edit.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/reportslider/reportslides/block.json");
...
function edit(_ref) {
  ...
  const degTax = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store).getEntityRecords("taxonomy", "degree", {
    per_page: -1
  }), []);
  var degTaxOptions = !Array.isArray(degTax) ? degreeTax : degTax.map(
  ...
  if (degTax && degTaxOptions) {
    degTaxOptions.unshift({
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Select a Degree"),
      value: ""
    });
  }
  const detTax = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store).getEntityRecords("taxonomy", "detail", {
    per_page: -1
  }), []);
  var detailTaxOptions = !Array.isArray(detTax) ? detailTax : detTax.map(
  // Format the options for display in the <SelectControl/>
  detailTax => ({
  ...
  if (detTax && detailTaxOptions) {
    detailTaxOptions.unshift({
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Select a Detail"),
      value: ""
    });
  }
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Button Link", "smt-theme"),
    initialOpen: true
...
/***/ "./src/blocks/reportslider/reportslides/block.json":
/*!*********************************************************!*\
  !*** ./src/blocks/reportslider/reportslides/block.json ***!
  \*********************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"smt-theme/reportslides","version":"0.1.5","title":"Report Slides","category":"block-category-listing","keywords":["report","list","slider"],"description":"","supports":{"html":false,"anchor":false,"customClassName":false},"attributes":{"degreeTax":{"type":"string","default":""},"detailTax":{"type":"string","default":""},"url":{"type":"string","default":""},"linkTarget":{"type":"string","default":""}},"parent":["smt-theme/reportslider"],"textdomain":"smt-theme","editorScript":"file:./index.js"}');
...
"use strict";
/*!*******************************************************!*\
  !*** ./src/blocks/reportslider/reportslides/index.js ***!
  \*******************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/reportslider/reportslides/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/reportslider/reportslides/block.json");
