...
/* harmony import */ var _icon_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./icon.json */ "./src/blocks/icon/icon.json");
...
class Edit extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(props) {
    ...
    this.state = {
      icons: _icon_json__WEBPACK_IMPORTED_MODULE_6__,
      isOpen: false,
      keyword: "",
      isEditingURL: false
    };
  ...
  search(keyword) {
    let filtered = [];
    (0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)(_icon_json__WEBPACK_IMPORTED_MODULE_6__, icon => {
  ...
  render() {
    ...
    const iconcolorclass = iconColorClass ? ` icon--color-${iconColorClass}` : "";
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    ...
    }, iconClass && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
      "data-key": iconClass,
    ...
    })) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("No characters found.", "block-options")))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Icon color", "smt-theme"),
      ...
      colorSettings: [{
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Icon Color", "smt-theme")
      }]
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Link Settings", "smt-theme"),
      initialOpen: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }))), undefined == url ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      id: anchor ? `${anchor}` : null,
      class: `icon ${iconClasses}`
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      class: "icon__helper"
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      class: `icon__visual ${iconClass}`
...
class Save extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  render() {
    ...
    const relation = relationAttribute && relationAttribute.length > 0 ? relationAttribute.join(" ") : null;
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, undefined == url ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      id: anchor ? `${anchor}` : null,
      class: `icon ${iconClasses}`
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      class: "icon__helper"
...
/***/ "./src/blocks/icon/styles/editor.scss":
/*!********************************************!*\
  !*** ./src/blocks/icon/styles/editor.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"smt-theme/icon","version":"0.1.0","title":"Icon","category":"block-category-basic","keywords":["icon"],"description":"","supports":{"html":false,"anchor":false,"customClassName":false},"attributes":{"iconColor":{"type":"string","default":"#39515E"},"iconColorClass":{"type":"string","default":"seven"},"iconClass":{"type":"string","default":"fa fa-wordpress"},"url":{"type":"string"},"linkTarget":{"type":"string"},"anchor":{"type":"string","default":""}},"textdomain":"smt-theme","parent":["smt-theme/column"],"editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "metadata": () => (/* reexport default export from named module */ _block_json__WEBPACK_IMPORTED_MODULE_7__),
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles/editor.scss */ "./src/blocks/icon/styles/editor.scss");
/* harmony import */ var _icon_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./icon.json */ "./src/blocks/icon/icon.json");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/icon/block.json");
