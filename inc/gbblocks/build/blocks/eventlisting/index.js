...
/***/ "./src/blocks/eventlisting/edit.js":
/*!*****************************************!*\
  !*** ./src/blocks/eventlisting/edit.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/eventlisting/block.json");
...
function edit(_ref) {
  ...
  const taxonomies = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_3__.store).getEntityRecords("taxonomy", "event-category", {
    per_page: -1
  }), []);
  ...
  }, typeof taxonomyOptions !== "undefined" && taxonomyOptions.length > 0 ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Select category", "smt-theme") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add a Event Category", "smt-theme")), taxonomyOptions?.map((item, index) => {
...
/***/ "./src/blocks/eventlisting/block.json":
/*!********************************************!*\
  !*** ./src/blocks/eventlisting/block.json ***!
  \********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"smt-theme/eventlisting","version":"0.1.5","title":"Event Listing","category":"block-category-listing","keywords":["event","list"],"description":"","supports":{"html":false,"anchor":false,"customClassName":false},"attributes":{"listTaxonomy":{"type":"array"},"eventListing":{"type":"boolean","default":false},"anchor":{"type":"string","default":""}},"parent":["smt-theme/section","smt-theme/sectionpattern","smt-theme/tabcontent"],"textdomain":"smt-theme","editorScript":"file:./index.js"}');
...
"use strict";
/*!******************************************!*\
  !*** ./src/blocks/eventlisting/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/eventlisting/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/eventlisting/block.json");
