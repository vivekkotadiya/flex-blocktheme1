...
function edit(_ref) {
  ...
  const blockClass = classnames__WEBPACK_IMPORTED_MODULE_2___default()(`box`, "" !== boxcolorClass ? `${boxcolorClass}` : null);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    ...
    showTooltip: true,
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("SPAN", "smt-theme")
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("label", null, "Box Link Setting"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
...
function save(_ref) {
  ...
  const ParagraphTag = tag;
  const boxcolorClass = colorClass ? `box--color-${colorClass}` : "";
  const blockClass = classnames__WEBPACK_IMPORTED_MODULE_1___default()(`box`, "" !== boxcolorClass ? `${boxcolorClass}` : null);
  const relAttributes = [];
  if (linkTarget) {
    relAttributes.push("noopener");
  }
  const relation = relAttributes && relAttributes.length > 0 ? relAttributes.join(" ") : null;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, undefined !== url ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: !!url ? url : null,
    className: blockClass,
    target: !!linkTarget ? "_blank" : null,
    rel: relation
    ...
    tagName: ParagraphTag,
    className: "box__text text text--style-two text--color-eight",
    value: boxParagraph
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"smt-theme/box","version":"0.1.0","title":"Box","category":"block-category-advanced","keywords":["Box"],"description":"","supports":{"html":false,"anchor":false,"customClassName":false},"attributes":{"boxColor":{"type":"string","default":"#39515E"},"colorClass":{"type":"string","default":"seven"},"level":{"type":"string","default":"span"},"tag":{"type":"string","default":"p"},"boxHeadline":{"type":"string","source":"html","selector":".box__headline","default":""},"boxParagraph":{"type":"string","source":"html","selector":".box__text","default":""},"url":{"type":"string","source":"attribute","selector":".box","attribute":"href"},"linkTarget":{"type":"string","source":"attribute","selector":".box","attribute":"target"}},"textdomain":"smt-theme","parent":["smt-theme/column"],"editorScript":"file:./index.js"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/blocks/box/block.json");
