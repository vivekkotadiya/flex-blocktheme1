...
/***/ "./src/blocks/bloglisting/view.js":
/*!****************************************!*\
  !*** ./src/blocks/bloglisting/view.js ***!
  \****************************************/
/***/ (() => {
    ...
    document.querySelectorAll(".listing-blog").forEach(function (blogList) {
      blogList.addEventListener("click", function (e) {
        ...
        if (e.target.classList.contains("listing-blog__filter-tax")) {
          e.preventDefault();
          document.querySelectorAll(".listing-blog__filter-tax").forEach(function (tax) {
            tax.classList.remove("active-tax");
          });
          getblogList(0, target.dataset.id, blogList, true);
          target.classList.toggle("active-tax");
        } else if (deviceTouch && !target.classList.contains("row-wrapper") && !target.classList.contains("row") && !target.classList.contains("listing-blog__content") && !target.classList.contains("listing-blog__loadMore") && !target.classList.contains("fa-spinner") && !target.closest(".listing-blog__item").classList.contains("listing-blog__item--active")) {
...
async function getBlogsPosts(url, body, position, isFilter) {
  ...
  if (response.status == 200) {
    if (data.html != "") {
      if (isFilter == true) {
        position.querySelector(".listing-blog__content .row").innerHTML = data.html;
        elementBlogOverlayHeight();
      } else {
        position.querySelector(".listing-blog__content .row").innerHTML += data.html;
        elementBlogOverlayHeight();
      }
      position.querySelector(".listing-blog__loadMore").dataset.paged = data.max_page;
      position.querySelector(".listing-blog__loadMore").classList.remove("active");
    }
    if (isFilter == true) {
      blogPaged = 2;
    }
...
const intersectionObserver = new IntersectionObserver(entries => {
  ...
  var tax = blogList.querySelector(".listing-blog__filter-tax.active-tax").dataset.id;
...
if (document.querySelector(".listing-blog__loadMore")) {
  intersectionObserver.observe(document.querySelector(".listing-blog__loadMore"));
}

/***/ }),

/***/ "./src/blocks/blogsection/blogslider/view.js":
/*!***************************************************!*\
  !*** ./src/blocks/blogsection/blogslider/view.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".blog-slider")) {
    ...
    for (var i = 0; i < selector.length; i++) {
      ...
      const mainNews = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](slide_ele, {
        type: "slide",
        arrows: true,
        easing: "linear",
        perPage: 2,
...
/***/ "./src/blocks/cardsslider/view.js":
/*!****************************************!*\
  !*** ./src/blocks/cardsslider/view.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.card__slider')) {
  var sliderselector = document.getElementsByClassName('card__slider');
  for (var i = 0; i < sliderselector.length; i++) {
    const slide_ele = sliderselector[i];
    const cardSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](slide_ele, {
      type: 'loop',
      perPage: 3,
      gap: 20,
      perMove: 1,
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  elements.forEach(function (item) {
    ...
    item.counterTarget = +item.querySelector(".counter__number-value").innerText;
    item.counterCount = 0;
    item.counterStep = item.counterTarget / item.counterSpeed;
    item.updateCounter = function () {
      item.counterCount = item.counterCount + item.counterStep;
      item.querySelector(".counter__number-value").innerText = Math.ceil(item.counterCount);
      if (item.counterCount < item.counterTarget) {
        setTimeout(item.updateCounter, 100);
      } else {
        item.querySelector(".counter__number-value").innerText = item.counterTarget;
      }
    };
  });
...
/***/ "./src/blocks/coursepreview/view.js":
/*!******************************************!*\
  !*** ./src/blocks/coursepreview/view.js ***!
  \******************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".course-overlay") !== undefined) {
    ...
    allOverlay.forEach((overlay, index) => {
      overlay.querySelector(".course-overlay__icon").addEventListener("click", function (event) {
      ...
      overlay.querySelector(".course-overlay__text").addEventListener("click", function (event) {
        this.parentElement.classList.remove("course-overlay--active");
      });
    });
  }
...
/***/ "./src/blocks/dozentenslider/view.js":
/*!*******************************************!*\
  !*** ./src/blocks/dozentenslider/view.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.dozenten_slider')) {
  var sliderselector = document.getElementsByClassName('dozenten_slider');
  for (var i = 0; i < sliderselector.length; i++) {
    const slide_ele = sliderselector[i];
    const dozentenSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](slide_ele, {
      type: 'fade',
      perPage: 1,
      perMove: 1,
      pauseOnHover: false,
...
/***/ "./src/blocks/eventlisting/view.js":
/*!*****************************************!*\
  !*** ./src/blocks/eventlisting/view.js ***!
  \*****************************************/
/***/ (() => {
...
async function getEventPosts(url, body, position) {
  ...
  if (response.status == 200) {
    if (data.html != "") {
      position.querySelector(".row").innerHTML += data.html;
      position.querySelector(".listing-event__loadMore").dataset.paged = data.max_page;
      position.querySelector(".listing-event__loadMore").classList.remove("active");
    }
  }
}
const intersectionObserver = new IntersectionObserver(entries => {
...
if (document.querySelector(".listing-event__loadMore")) {
  intersectionObserver.observe(document.querySelector(".listing-event__loadMore"));
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.querySelector('input[name="time"]')) {
    document.querySelector('input[name="time"]').value = Math.floor(new Date().getTime() / 1000);
  }
      ...
      form.querySelector('input[type="submit"]').addEventListener("click", function (event) {
        ...
        inputs.forEach(function (input) {
          ...
          if (input.parentElement.tagName === "LABEL") {
            elementlabel = input.parentElement.getAttribute("for");
          } else {
          ...
          switch (elementType) {
            ...
            case "email":
              if (elementValue === "") {
                ...
                formControl.classList.add("show");
                formControl.innerHTML = elementlabel + " address is not valid.";
                formValidation = false;
              }
              break;
            case "checkbox":
              let isChecked = document.querySelector('[name="' + elementName + '"]:checked');
              if (!isChecked) {
                input.closest(".acceptance").previousElementSibling.classList.add("show");
                input.closest(".acceptance").previousElementSibling.innerHTML = elementlabel + " is required feild.";
                formValidation = false;
              }
              break;
          }
        ...
        if (formValidation == true) {
          errors.forEach(err => {
            if (err.classList.contains("show") == true) err.classList.remove("show");
          });
          form.querySelector('input[type="submit"]').disabled = true;
          const params = new URLSearchParams();
          params.append("action", "sendEmail");
          params.append("clientid", form.querySelector('input[name="clientId"]').value);
          params.append("time", form.querySelector('input[name="time"]').value);
          params.append("con_name", form.querySelector('input[name="con_name"]').value);
          params.append("firstname", form.querySelector('input[name="name"]').value);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.getElementById("header__scroll") !== null) {
    ...
    document.getElementById("header__scroll").addEventListener("click", function (e) {
      // Check if navigation is open
      if (!document.querySelector("body").classList.contains("page--nav-open")) {
        // Scroll to top
        window.scrollTo({
          top: 0,
          behavior: "smooth"
  ...
  if (document.getElementById("header__contact") !== null && document.getElementById("popup__contact") !== null) {
    // Get contact overlay
    var contactOverlay = document.getElementById("popup__contact");

    // Add event listener to contact icon
    document.getElementById("header__contact").addEventListener("click", function (e) {
    ...
    if (contactOverlay.querySelector(".popup__close") !== null) {
      ...
      contactOverlay.querySelector(".popup__close").addEventListener("click", function (e) {
        // Add or remove open class
        contactOverlay.classList.toggle("popup--open");
      });
    }
  ...
  function toggleHeaderNavOpen() {
    ...
    setTimeout(function () {
      ...
      document.querySelectorAll("#header__nav-wrapper > .menu-helper ul").forEach(function (elem, i) {
        // NEEDED?        // Remove status open for all navigation and sub
        elem.classList.remove("menu--open");
      });

      // Get all navigation list elements
      document.querySelectorAll("#header__nav-wrapper > .menu-helper ul li").forEach(function (elem, i) {
  ...
  if (document.getElementById("header__toggle") !== null && document.getElementById("header__nav-close") !== null) {
    // Add event listener to hamburger icon
    document.getElementById("header__toggle").addEventListener("click", function (e) {
      // Execute action
      toggleHeaderNavOpen();
    });

    // Add event listener to close icon
    document.getElementById("header__nav-close").addEventListener("click", function (e) {
      // Execute action
      toggleHeaderNavOpen();
    });
  }
  ...
  function linkHeaderNavBack() {
    ...
    var linkHeaderNavBackItems = document.querySelectorAll("#header__nav-wrapper > .menu-helper li .menu__back");
    ...
    if (linkHeaderNavBackItems !== undefined) {
      ...
      linkHeaderNavBackItems.forEach(function (item, i) {
        ...
        item.addEventListener("click", function (e) {
          ...
          document.getElementById("header__nav-wrapper").scroll({
            top: 0,
            behavior: "smooth"
          });

          // Close navigation slide
          this.parentElement.parentElement.parentElement.classList.remove("menu__item--open");

          // NEEDED?          // Close navigation slide
          this.parentElement.parentElement.parentElement.parentElement.classList.remove("menu--open");
        });
      });
    }
  }
            ...
            if (width <= 1400) {
              ...
              if (!parent.parentElement.classList.contains("menu--sub")) {
                ...
                if (!parent.classList.contains("menu__item--open")) {
                  ...
                  linkHeaderNavItems.forEach(function (cleanupItem, i) {
                    // Remove navigation open indicator class
                    cleanupItem.parentElement.classList.remove("menu__item--open");
                ...
                if (!parent.parentElement.parentElement.parentElement.classList.contains("menu--sub")) {
                  parent.parentElement.querySelectorAll(".menu__item--open").forEach(function (navSiblings, i) {
...
/***/ "./src/blocks/reportslider/reportslides/view.js":
/*!******************************************************!*\
  !*** ./src/blocks/reportslider/reportslides/view.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".report-slider__lists")) {
    ...
    for (var i = 0; i < selector.length; i++) {
      const slide_ele = selector[i];
      const mainReport = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](slide_ele, {
        type: "slide",
        easing: "linear",
        perPage: 2,
        perMove: 1,
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.querySelector(".tabs")) {
    ...
    lists.forEach((list, index) => {
      ...
      document.getElementById(listItemContent).classList.add("tabs-content__item--active");
      ...
      listItemAll.forEach((item, index) => {
        item.addEventListener("click", function (e) {
          ...
          if (item.classList.contains("tabs-nav__item--active") == false && item.dataset.content) {
            // Remove current Tab Class "active"
            var currentItem = item.parentElement.querySelector(".tabs-nav__item--active");
            var currentItemContent = currentItem.dataset.content;
            currentItem.classList.remove("tabs-nav__item--active");
            item.parentElement.parentElement.querySelector("[id='" + currentItemContent + "']").classList.remove("tabs-content__item--active");

            // Add new Tab Class "active"
            var newItemContent = item.dataset.content;
            item.classList.add("tabs-nav__item--active");
            item.parentElement.parentElement.querySelector("[id='" + newItemContent + "']").classList.add("tabs-content__item--active");
          }
        });
      });
    });
...
/***/ "./src/blocks/testimonialslider/view.js":
/*!**********************************************!*\
  !*** ./src/blocks/testimonialslider/view.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.testimonial_slider')) {
  var sliderselector = document.getElementsByClassName('testimonial_slider');
  for (var i = 0; i < sliderselector.length; i++) {
    const slide_ele = sliderselector[i];
    const testimonialSlider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"](slide_ele, {
      type: 'fade',
      perPage: 1,
      perMove: 1,
      pauseOnHover: false,
...
function setTimelineItems() {
  document.querySelectorAll(".timeline").forEach(function (timeline) {
    ...
    arrayOfItems.forEach(function (item) {
      ...
      item.style.height = item.querySelector(".timeline-item__content").getBoundingClientRect().height + "px";
...
document.addEventListener("DOMContentLoaded", function () {
  if (document.querySelector(".youtube.youtube--big") != null) {
      ...
      link.addEventListener("click", function (e) {
        ...
        if (document.querySelector(".lightbox-youtube") != null) {
          ...
          if (iframe.src.indexOf("/" + youtubeId + "/?showinfo=0") < 0) {
            iframe.src = "https://www.youtube.com/embed/" + youtubeId + "/?showinfo=0";
          }
...
/***/ "./src/blocks/youtubesmall/view.js":
/*!*****************************************!*\
  !*** ./src/blocks/youtubesmall/view.js ***!
  \*****************************************/
/***/ (() => {
...
/* harmony import */ var _blocks_navigation_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../blocks/navigation/view */ "./src/blocks/navigation/view.js");
/* harmony import */ var _blocks_navigation_view__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_blocks_navigation_view__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _blocks_icon_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../blocks/icon/view */ "./src/blocks/icon/view.js");
/* harmony import */ var _blocks_icon_view__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_blocks_icon_view__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _blocks_accordion_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../blocks/accordion/view */ "./src/blocks/accordion/view.js");
/* harmony import */ var _blocks_accordion_view__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_blocks_accordion_view__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _blocks_tabs_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../blocks/tabs/view */ "./src/blocks/tabs/view.js");
/* harmony import */ var _blocks_tabs_view__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_blocks_tabs_view__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _blocks_bloglisting_view__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../blocks/bloglisting/view */ "./src/blocks/bloglisting/view.js");
/* harmony import */ var _blocks_bloglisting_view__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_blocks_bloglisting_view__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _blocks_eventlisting_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../blocks/eventlisting/view */ "./src/blocks/eventlisting/view.js");
/* harmony import */ var _blocks_eventlisting_view__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_blocks_eventlisting_view__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _blocks_blogsection_blogslider_view__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../blocks/blogsection/blogslider/view */ "./src/blocks/blogsection/blogslider/view.js");
/* harmony import */ var _blocks_form_view__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../blocks/form/view */ "./src/blocks/form/view.js");
/* harmony import */ var _blocks_form_view__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_blocks_form_view__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _blocks_youtubesmall_view__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../blocks/youtubesmall/view */ "./src/blocks/youtubesmall/view.js");
/* harmony import */ var _blocks_youtubesmall_view__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_blocks_youtubesmall_view__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _blocks_youtubebig_view__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../blocks/youtubebig/view */ "./src/blocks/youtubebig/view.js");
/* harmony import */ var _blocks_youtubebig_view__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_blocks_youtubebig_view__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _blocks_coursepreview_view__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../blocks/coursepreview/view */ "./src/blocks/coursepreview/view.js");
/* harmony import */ var _blocks_coursepreview_view__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_blocks_coursepreview_view__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _blocks_reportslider_reportslides_view__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../blocks/reportslider/reportslides/view */ "./src/blocks/reportslider/reportslides/view.js");
/* harmony import */ var _blocks_counter_view__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../blocks/counter/view */ "./src/blocks/counter/view.js");
/* harmony import */ var _blocks_counter_view__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_blocks_counter_view__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _blocks_timeline_view__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../blocks/timeline/view */ "./src/blocks/timeline/view.js");
/* harmony import */ var _blocks_timeline_view__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_blocks_timeline_view__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _blocks_testimonialslider_view__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../blocks/testimonialslider/view */ "./src/blocks/testimonialslider/view.js");
/* harmony import */ var _blocks_dozentenslider_view__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../blocks/dozentenslider/view */ "./src/blocks/dozentenslider/view.js");
/* harmony import */ var _blocks_cardsslider_view__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../blocks/cardsslider/view */ "./src/blocks/cardsslider/view.js");
